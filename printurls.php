...
$url = new moodle_url('/lib/editor/tiny/plugins/c4l/printurls.php', []);
$PAGE->set_url($url);
...
$fs = get_file_storage();
$files = $fs->get_area_files(context_system::instance()->id, 'tiny_c4l', 'images');
$processedfiles = [];
...
echo($OUTPUT->render_from_template('tiny_c4l/imageurls', ['imageurls' => $processedfiles]));
